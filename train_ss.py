...
logger = logging.getLogger('nanodet_nni_ss')
...
if __name__ == '__main__':
    try:
        ...
        params = vars(merge_parameter(cfg, tuner_params))
        print('print-----param',params) # {'data_dir': './data', 'batch_size': 64, 'batch_num': None, 'hidden_size': 512, 'lr': 0.01, 'momentum': 0.5, 'epochs': 10, 'seed': 1, 'no_cuda': False, 'log_interval': 1000}
        main(params)
