...
model_urls = {
    'shufflenetv2_0.25x': None, 
    'shufflenetv2_0.5x': None, #'https://download.pytorch.org/models/shufflenetv2_x0.5-f707e7126e.pth',
    'shufflenetv2_1.0x': None, #'https://download.pytorch.org/models/shufflenetv2_x1-5666bf0f80.pth',
...
class ShuffleNetV2(nn.Module):
    def __init__(self,
        ...
        if model_size == '0.25x':
            self._stage_out_channels = [24, 48, 48, 96, 256]
